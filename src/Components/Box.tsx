...
export default function Box({children,className,absolute,transparent}:propTypes) {
  return (
    <div className={clsx(`p-8 px-6 lg:px-8 ${transparent?"":"bg-darkgrey"} overflow-hidden ${absolute?"":"relative"} rounded-md`,className?className:"")}>
