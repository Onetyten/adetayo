...
export default function Project() {
  ...
  return (
    <div className='max-w-full min-h-dvh gap-0.5 relative p-0.5 flex text-text font-grotesk'>
        <div ref={leftBoxRef} className="lg:min-w-md w-full lg:w-lg flex-shrink-0 max-w-full">
            <Box absolute className="gap-8 left-0 flex flex-col justify-start h-full lg:h-dvh items-start">
